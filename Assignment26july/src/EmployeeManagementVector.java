...
public class EmployeeManagementVector {
		public static void main(String[] args) {
			//creating employee object
			EmployeeV emp1=new EmployeeV(321,"Smuel","s@gmail.com","Male",34900.50f);
			EmployeeV emp2=new EmployeeV(322,"Alaska","a@gmail.com","Female",44900.00f);
			EmployeeV emp3=new EmployeeV(323,"Urvi","u@gmail.com","Female",50000.0f);
			EmployeeV emp4=new EmployeeV(324,"Rudy","r@gmail.com","Male",33900.50f);
				
			//add Employee to DB
			EmployeeDBV ed1=new EmployeeDBV();
	...
	class EmployeeV{
		 ...
		 String gender;
		 float salary;
		EmployeeV(int eid,String en,String em,String gn,float sal)
		{
			empId=eid;
			empName=en;
			email=em;
	...
	class EmployeeDBV{
		Vector<EmployeeV> emp=new Vector<>();
		boolean addEmployee(EmployeeV e) {
			if(emp.contains(e))
			{
			return false;
			}
